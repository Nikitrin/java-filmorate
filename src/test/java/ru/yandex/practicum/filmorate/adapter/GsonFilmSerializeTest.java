...
//    @Test
//    void filmToJson() {
//        Film filmGoodNurse = new Film(1, "Good Nurse", "About a serial killer",
//                LocalDate.of(2022, 9, 11), Duration.ofMinutes(121), null);
//        String json = "{\n" +
//                "  \"id\": 1,\n" +
//                "  \"likes\": [],\n" +
//                "  \"name\": \"Good Nurse\",\n" +
...
//        Film filmGoodNurse = new Film(1, "Good Nurse", "About a serial killer",
//                LocalDate.of(2022, 9, 11), Duration.ofMinutes(121), null);
//        Film filmPalmSprings = new Film(2, "Palm Springs", "About a time loop",
//                LocalDate.of(2020, 7, 10), Duration.ofMinutes(90), null);
