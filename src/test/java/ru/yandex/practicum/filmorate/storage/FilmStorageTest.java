...
//        filmKnivesOut = new Film(null, "Knives Out", "Comedy detective film",
//                LocalDate.of(2019, 11, 27), Duration.ofMinutes(130));
//        filmTranscendence = new Film(null, "Transcendence", "Science fiction film",
...
//        Assertions.assertEquals(1, film.getId(), "The film has been assigned an id");
//       // Assertions.assertEquals(new HashSet<Long>(), film.getLikes(), "Initialized field for likes");
//        Assertions.assertEquals(film, filmStorage.getFilmById(1), "Film saved in the storage");
//
...
//        Film film = new Film(1, "Bad Nurse", "About a crazy nurse",
...
//        Assertions.assertEquals(film, filmStorage.getFilmById(1), "Check saved value");
//
...
//        Assertions.assertEquals(saveFilmKnivesOut, filmStorage.getFilmById(1), "Get film by first id");
//        Assertions.assertEquals(saveFilmTranscendence, filmStorage.getFilmById(2), "Get film by second id");
//        Assertions.assertThrows(NotFoundException.class, () -> filmStorage.getFilmById(Integer.MAX_VALUE),
//                "Film with id not find");
//    }
//
//    @Test
//    void isFilmExist() {
//        filmStorage.saveFilm(filmKnivesOut);
//        Assertions.assertTrue(filmStorage.isFilmExist(1), "Check film exist");
//        Assertions.assertFalse(filmStorage.isFilmExist(Integer.MAX_VALUE), "Check film no exist");
//    }
//}